...
function deleteEntry(remove_URL){
	...
	if(confirm("Are you really want to delete this job vacancy!")){
...
function changeRecordsPerPage(base_url){
	...
	location.href = document.getElementById('base___URL').value+'admin/general/chnageRecordsPerPage/jobVacancies/'+recordsPerPage;
}