...
function validateInfo(){
	...
	if(document.getElementById('name').value == 'Enter city name.'){
...
function deleteEntry(remove_URL){
	...
	if(confirm("Data under this city including Agents IATA, Package Type and Hotel will also be removed. Are you really want to delete this city!")){
...
function changeRecordsPerPage(base_url){
	...
	location.href = document.getElementById('base___URL').value+'admin/general/chnageRecordsPerPage/cities/'+recordsPerPage;
}
