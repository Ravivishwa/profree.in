...
function deleteEntry(remove_URL){
	...
	if(confirm("Are you really want to delete this donation!")){
...
function changeRecordsPerPage(base_url){
	...
	location.href = document.getElementById('base___URL').value+'admin/general/chnageRecordsPerPage/donations/'+recordsPerPage;
}


function changeAllCourses(totalRows){
	
	if(document.getElementById('check_all_courses').checked){
