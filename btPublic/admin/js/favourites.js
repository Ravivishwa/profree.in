...
function deleteEntry(remove_URL){
	...
	if(confirm("Are you really want to delete this property!")){
...
function changeRecordsPerPage(base_url){
	...
	location.href = document.getElementById('base___URL').value+'admin/general/chnageRecordsPerPage/projects/'+recordsPerPage;
}
