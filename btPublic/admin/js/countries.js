...
function validateInfo(){
	...
	if(document.getElementById('name').value == 'Enter country name.'){
		
		document.getElementById('name').value = '';
			
	}
	
	if(document.getElementById('currency').value == 'Enter country currency code.'){
		
		document.getElementById('currency').value = '';
			
	}
	
	if(document.getElementById('currencySignature').value == 'Enter country currency signature.'){
		
		document.getElementById('currencySignature').value = '';
...
function deleteEntry(remove_URL){
	...
	if(confirm("Are you really want to delete this country!")){
...
function changeRecordsPerPage(base_url){
	...
	location.href = document.getElementById('base___URL').value+'admin/general/chnageRecordsPerPage/countries/'+recordsPerPage;
}