...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/pvcpayment/p/'.$page?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to Payment Plans</a>
            ...
            <form action="<?=base_url().'admin/pvcpayment/update/'.$ID.'/'.$page?>" method="post" onsubmit="return validateInfo();" enctype="multipart/form-data">
...
<!--				<input type="hidden" name="picture" value="--><?//=$picture?><!--" />-->
                ...
                <a href="<?=base_url().'admin/pvcpayment/p/'.$page?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
