...
<!-- 
                ...
                <div class="grid-data" style="width:180px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/title'?>">Title</a></div>
               <div class="grid-data" style="width:100px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Price</a></div>
               <div class="grid-data" style="width:180px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Packaging,Handling,etc.</a></div>
               <div class="grid-data" style="width:100px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Tax(in %)</a></div>
               <div class="grid-data" style="width:90px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Total</a></div>
...
<!--                <div class="grid-data" style="width:90px; color:#000;"><strong>Status</strong></div>-->
                ...
                ?>
                    ...
                    <div class="grid-head" style="background:<?=$bgColor?>;">
                        ...
                        <div class="grid-data" style="width:180px;"><a href="<?=base_url().'admin/pvcpayment/update/'.$row->ID.'/'.$page?>" title="Edit / Update..." style="font-weight:normal; color:#999999;"><?=shortDescription($row->title, 60, '<strong> .....</strong>');?></a></div>
                        <div class="grid-data" style="width:100px;"><?php echo $site_currency;?><?=$row->price?> </div>
                        <div class="grid-data" style="width:180px;text-align: center;"><?=$row->others?> </div>
                        <div class="grid-data" style="width:100px;"><?=$row->tax?> </div>
                        <div class="grid-data" style="width:90px;"><?=$row->total ?> </div>
