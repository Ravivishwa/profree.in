...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/news/add'?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/add-large.png" width="24" height="24" />Add Advertisement</a>
			...
			?>            
            	...
            	<form id="FRM_ACTIVE_ALL" action="<?=base_url().'admin/news/performAction/'.$page?>" method="post">
                ...
                <ul>
                	...
                	<li><a href="<?=base_url().'admin/news/add'?>">Add New</a></li>
                ...
                <div class="grid-data2"><a href="<?=base_url().'admin/news/Sort/ID'?>">#</a></div>

                <div class="grid-data" style="width:400px; color:#000;"><a href="<?=base_url().'admin/news/Sort/question'?>">Title</a></div>
                
                <div class="grid-data" style="width:120px; color:#000;"><a href="<?=base_url().'admin/news/Sort/date'?>">Date</a></div>
                ...
                ?>
                    ...
                    <div class="grid-head" style="background:<?=$bgColor?>;">                    	
                        ...
                        <div class="grid-data" style="width:400px;"><a href="<?=base_url().'admin/news/update/'.$row->ID.'/'.$page?>" title="Edit / Update..." style="font-weight:normal; color:#999999;"><?=shortDescription($row->title, 60, '<strong> .....</strong>');?></a></div> 
                        
                        <div class="grid-data" style="width:120px;"><?=displayDate($row->date)?></div>                       

                        <div class="grid-data" style="width:120px;"><a href="<?=base_url().'admin/news/changeStatus/'.$row->ID.'/'.$row->status.'/'.$page?>" style="color:#999999; font-weight:normal;"><?=showStatus($row->status)?></a></div>

                        <div class="grid-data">

                            <div style="float:left; padding-right:7px;"><a href="<?=base_url().'admin/news/update/'.$row->ID.'/'.$page?>" title="Edit / Update..."><img src="<?=base_url()?>btPublic/admin/images/edit.png" style="padding-top:3px;" /></a></div>

                            <div style="float:left;"> | </div>

                            <div style="float:left; padding-left:7px;"><a href="javascript: void(0);" title="Remove..." onclick="deleteEntry('<?=base_url().'admin/news/delete/'.$row->ID.'/'.$page?>')"><img src="<?=base_url()?>btPublic/admin/images/delete.png" style="margin-top:3px;" /></a></div>
            ...
            <?php
				...
				if($page > 0){
					...
					redirect(base_url().'admin/news/p/'.($page-$per_page), 'refresh');
				...
				if((bool)($this->session->userdata($sessionSearch)) == TRUE){										
					...
					echo '<div class="info_MSG">No news available for this section.<br/>Click <a href="'.base_url().'admin/news/add">HERE</a> to add news...</div>';
