...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/agents'?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to agents</a>
            ...
            <form action="<?=base_url().'admin/agents/add'?>" method="post" onsubmit="return validateInfo();">
            	...
            	<input type="text" name="userName" id="userName" class="field2" value="<?=$userName?>" onkeypress="claerMessage();" onclick="clearFieldValue('userName', 'Enter user name.');" onblur="addFieldValue('userName', 'Enter user name.')" autocomplete = "off"/>
                ...
                <input name="btnAddAgent" type="submit" value="Add new agent" class="button_1"  />

                <a href="<?=base_url().'admin/agents'?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
