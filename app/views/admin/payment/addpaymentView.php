...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/payment'?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to Payment Plans</a>
            ...
            <form action="<?=base_url().'admin/payment/add'?>" method="post" onsubmit="return validateInfo();" enctype="multipart/form-data">
...
filebrowserFlashUploadUrl : '<?php echo $path; ?>core/connector/php/connector.php?command=QuickUpload&type=Flash'
                ...
                <input name="btnAddpayment" type="submit" value="Save" class="button_1"  />

                <a href="<?=base_url().'admin/payment'?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
