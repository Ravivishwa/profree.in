...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/homeSlider/add'?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/add-large.png" width="24" height="24" />Add Slider</a>
            ...
            <div class="search_DIV">
				...
				$data['controller__Name'] = 'homeSlider';								
			...
			?>            
            	...
            	<form id="FRM_ACTIVE_ALL" action="<?=base_url().'admin/homeSlider/performAction/'.$page?>" method="post">
                ...
                <ul>
                	...
                	<li><a href="<?=base_url().'admin/homeSlider/add'?>">Add New</a></li>
                ...
                <div class="grid-data2"><a href="<?=base_url().'admin/homeSlider/Sort/ID'?>">#</a></div>

                <div class="grid-data" style="width:200px; color:#000;"><a>Title</a></div>
                
                <div class="grid-data" style="width:200px; color:#000;"><a>Slide</a></div>
                ...
                ?>
                    ...
                    <div class="grid-head" style="background:<?=$bgColor?>;">                    	
                        ...
                        <div class="grid-data" style="width:200px;"><?=$row->title?></div> 
                        
                        <div class="grid-data" style="width:200px;"><a href="<?=base_url().'admin/homeSlider/update/'.$row->ID.'/'.$page?>" title="Edit / Update..." style="font-weight:normal; color:#999999;"><img src="<?=base_url().'btPublic/bt-uploads/thumbs/'.$row->image?>" width="40" height="25" /></a><div style="clear:both;"></div></div> 
                        
                        <div class="grid-data" style="width:120px;"><?=displayDate($row->date)?></div>                       

                        <div class="grid-data" style="width:120px;"><a href="<?=base_url().'admin/homeSlider/changeStatus/'.$row->ID.'/'.$row->status.'/'.$page?>" style="color:#999999; font-weight:normal;"><?=showStatus($row->status)?></a></div>

                        <div class="grid-data">

                            <div style="float:left; padding-right:7px;"><a href="<?=base_url().'admin/homeSlider/update/'.$row->ID.'/'.$page?>" title="Edit / Update..."><img src="<?=base_url()?>btPublic/admin/images/edit.png" style="padding-top:3px;" /></a></div>

                            <div style="float:left;"> | </div>

                            <div style="float:left; padding-left:7px;"><a href="javascript: void(0);" title="Remove..." onclick="deleteEntry('<?=base_url().'admin/homeSlider/delete/'.$row->ID.'/'.$page?>')"><img src="<?=base_url()?>btPublic/admin/images/delete.png" style="margin-top:3px;" /></a></div>
            ...
            <?php
				...
				if($page > 0){
					...
					redirect(base_url().'admin/homeSlider/p/'.($page-$per_page), 'refresh');
				...
				if((bool)($this->session->userdata($sessionSearch)) == TRUE){										
					...
					echo '<div class="info_MSG">No Slider available for this section.<br/>Click <a href="'.base_url().'admin/homeSlider/add">HERE</a> to add Home Slider...</div>';
