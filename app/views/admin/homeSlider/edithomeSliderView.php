...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/homeSlider/p/'.$page?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to Home Slider</a>
            ...
            <form action="<?=base_url().'admin/homeSlider/update/'.$ID.'/'.$page?>" method="post" onsubmit="return validateInfo();" enctype="multipart/form-data">
                ...
                <div class="clear"></div>                                                             
              	...
              	<label>Picture: (W:635, H:540) <img src="<?=base_url().'btPublic/bt-uploads/thumbs/'.$picture;?>" /> </label>
                <div class="clear"></div>
                ...
                <div class="clear"></div>
            	<textarea name="description" id="description" style="width:300px; height:100px;"><?=$description?></textarea>
...
filebrowserFlashUploadUrl : '<?php echo $path; ?>core/connector/php/connector.php?command=QuickUpload&type=Flash'
                ...
                <input name="btnUpdatehomeSlider" type="submit" value="Update Home Slider" class="button_1"  />

                <a href="<?=base_url().'admin/homeSlider/p/'.$page?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
