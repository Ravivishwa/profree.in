...
<script type="text/javascript" src="<?=base_url()?>btPublic/admin/js/newsLetters.js"></script>
...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div class="search_DIV">
				...
				$data['controller__Name'] = 'newsLetters';								
			...
			?>            
            	...
            	<form id="FRM_ACTIVE_ALL" action="<?=base_url().'admin/newsLetters/performAction/'.$page?>" method="post">
                ...
                <div class="grid-data2"><a href="<?=base_url().'admin/newsLetters/Sort/ID'?>">#</a></div>

                <div class="grid-data" style="width:390px; color:#000;"><a href="<?=base_url().'admin/newsLetters/Sort/email'?>">Email Address </a></div>
                <div class="grid-data" style="width:155px; color:#000;"><a href="<?=base_url().'admin/newsLetters/Sort/date'?>">Date </a></div>                 
                ...
                ?>
                    ...
                    <div class="grid-head" style="background:<?=$bgColor?>;">                    	
                        ...
                        <div class="grid-data" style="width:390px;"><?=$row->email;?></div> 
                        
                        <div class="grid-data" style="width:155px;"><?=displayDate($row->date)?></div>                      

                        <div class="grid-data" style="width:120px;"><a href="<?=base_url().'admin/newsLetters/changeStatus/'.$row->ID.'/'.$row->status.'/'.$page?>" style="color:#999999; font-weight:normal;"><?=showStatus($row->status)?></a></div>

                        <div class="grid-data">
							<a href="javascript: void(0);" title="Remove..." onclick="deleteEntry('<?=base_url().'admin/newsLetters/delete/'.$row->ID.'/'.$page?>')"><img src="<?=base_url()?>btPublic/admin/images/delete.png" style="margin-top:3px; margin-left:15px;" /></a>
            ...
            <?php
				...
				if($page > 0){
					...
					redirect(base_url().'admin/newsLetters/p/'.($page-$per_page), 'refresh');
				...
				if((bool)($this->session->userdata($sessionSearch)) == TRUE){										
					...
					echo '<div class="info_MSG">No News Letter Subscribers available for this section.</div>';
