        ...
        if((bool)$QUERY > 0){
            ...
            <form id="FRM_ACTIVE_ALL" action="<?=base_url().'admin/pvcpayment/performAction/'.$page?>" method="post">
                ...
                <div class="grid-head" style="background:#f4f1f1;">
                    ...
                    <div class="grid-data" style="width:120px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/title'?>">Service</a></div>
                    <div class="grid-data" style="width:100px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Name</a></div>
                    <div class="grid-data" style="width:90px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Contact</a></div>
                    <div class="grid-data" style="width:90px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Address</a></div>
                    <div class="grid-data" style="width:90px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">Password</a></div>
                    <div class="grid-data" style="width:50px; color:#000;"><a href="<?=base_url().'admin/pvcpayment/Sort/price'?>">File</a></div>
                ...
                foreach($QUERY->result() as $row){
                    ...
                    <div class="grid-head" style="background:<?=$bgColor?>;">
                        ...
                        <div class="grid-data" style="width:50px;"><?=$row->service?> </div>
                        <div class="grid-data" style="width:100px;"><?=$row->name?> </div>
                        <div class="grid-data" style="width:90px;"><?=$row->contact ?> </div>
                        <div class="grid-data" style="width:90px;"><?=$row->address ?> </div>
                        <div class="grid-data" style="width:90px;"><?=$row->password ?> </div>
                        <div class="grid-data" style="width:50px;">
                            <a title="Click to download" href="<?php echo base_url().'btPublic/bt-uploads/'.$row->filepath?>" download>Download</a>
                        </div>
