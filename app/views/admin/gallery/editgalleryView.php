...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	<a href="<?=base_url().'admin/gallery/p/'.$page?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to gallery</a>
            </div>
            <div class="clear"></div>                        
            
            <form action="<?=base_url().'admin/gallery/update/'.$ID.'/'.$page?>" method="post" onsubmit="return validateInfo();">           	
                
                <label>Gallery title / category: *</label>
                <div class="clear"></div>
                <input type="text" name="name" id="name" class="field2" value="<?=$name?>" onkeypress="claerMessage();"/>
                <?php echo form_error('name', '<div class="error" id="titleError">', '</div>');?>
               	<div class="pixel_space3"></div>
                <div class="clear"></div>
                                                            
                                
                <input name="btnUpdategallery" type="submit" value="Update gallery" class="button_1"  />
                <a href="<?=base_url().'admin/gallery/p/'.$page?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
                <div class="clear"></div>
                <div class="pixel_space3"></div>
            </form>
