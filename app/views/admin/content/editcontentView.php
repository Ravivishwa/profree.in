...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/content/p/'.$page?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to Content</a>
            ...
            <form action="<?=base_url().'admin/content/update/'.$ID.'/'.$page?>" method="post" onsubmit="return validateInfo();">

            	<label>Page name: *</label>

                <div class="clear"></div>

            	<input type="text" name="page__name" id="page__name" class="field2" value="<?=$page__name?>" readonly="readonly" />
...
filebrowserFlashUploadUrl : '<?php echo $path; ?>core/connector/php/connector.php?command=QuickUpload&type=Flash'
                ...
                <input name="btnUpdatecontent" type="submit" value="Update Content" class="button_1"  />

                <a href="<?=base_url().'admin/content/p/'.$page?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
