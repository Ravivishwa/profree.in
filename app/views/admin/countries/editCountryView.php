...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	...
            	<a href="<?=base_url().'admin/countries/'.$page?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to countries</a>
            ...
            <form action="<?=base_url().'admin/countries/update/'.$ID.'/'.$page?>" method="post" onsubmit="return validateInfo();" enctype="multipart/form-data">
                ...
                <input name="btnUpdateCountry" type="submit" value="Update country" class="button_1"  />

                <a href="<?=base_url().'admin/countries/'.$page?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
