...
<div class="wrapper">
    ...
    <div class="rightbar">
            ...
            <div style="float:right; padding-top:20px;">
            	<a href="<?=base_url().'admin/cities'?>" class="top_link"><img src="<?=base_url()?>btPublic/admin/images/icons-big/back.png" width="24" height="24" />Back to cities</a>
            </div>
            <div class="clear"></div>                        
            
            <form action="<?=base_url().'admin/cities/add'?>" method="post" onsubmit="return validateInfo();">
                ...
                <input name="btnAddCity" type="submit" value="Add new city" class="button_1"  />
                <a href="<?=base_url().'admin/cities'?>" style="text-decoration:none;"><input type="button" value="Cancel" class="button_1"  /></a>
            </form>
