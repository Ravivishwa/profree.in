                ...
                <div class="col-md-7">
					...
					if($QUERY->num_rows){
                        ...
                        <div class="listingwraper">
                            <div class="titlewraper"><b><?=$agent_name?>'s</b> Properties</div>
						...
						?>
                        <div  class="hedingbar" style="background:none; color:#272E68;">No property found!<br/>Try to search again with different keywords.</div>
                        <?php
					}
					?>
